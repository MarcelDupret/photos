...
function preencherFigurinhas() {
    ...
    for (const slot of slots) {
        ...
        const altText = slotNameEl ? slotNameEl.textContent : "Produto";
        ...
        // Adiciona classe de preenchido quando carregada
        img.onload = () => slot.classList.add("slot-preenchido");
        img.onerror = () => console.warn(`Imagem não encontrada: ${imgSrc}`);

        // Insere a imagem no início do slot
        slot.insertBefore(img, slot.firstChild);
    }
    console.log("✅ Imagens locais do catálogo carregadas com sucesso!");
}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    try {
        pageFlip = new St.PageFlip(bookElement, {
            ...
            disableFlipByClick: false, // Desativado porque o drag custom já previne viradas acidentais
